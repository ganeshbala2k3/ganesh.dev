      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
                className="w-full h-full object-cover absolute left-1/2 bottom-[-1px]"
                src={avatarUrl}
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div className="flex flex-col items-start gap-1 sm:gap-1.5">
                      ...
                      <div className="text-[10px] sm:text-sm text-white/70 leading-none">{status}</div>
                    </div>
                  </div>
                  <button
            ...
            >
              <div className="w-full absolute flex flex-col pt-8" style={{ bottom: '4.5rem', display: 'flex', gridArea: 'auto', paddingBottom: '1rem' }}>
                <h3
                  className="font-black m-0 text-black tracking-tight"
                  style={{
                    fontSize: 'min(5svh, 3em)',
                    display: 'block',
                    gridArea: 'auto',
                    pointerEvents: 'auto',
                    textShadow: '0 0 24px rgba(255,255,255,1), 0 0 12px rgba(255,255,255,1), 0 0 4px rgba(255,255,255,1)'
                  }}
                >
                  {name}
                </h3>
                <p
                  className="font-extrabold whitespace-nowrap mx-auto w-min text-black"
                  style={{
                    position: 'relative',
                    top: '-4px',
                    fontSize: '18px',
                    ...
                    gridArea: 'auto',
                    pointerEvents: 'auto',
                    textShadow: '0 0 16px rgba(255,255,255,1), 0 0 8px rgba(255,255,255,1)'
                  }}
                >
                  {title}
                </p>
