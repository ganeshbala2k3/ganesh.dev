...
export function Terminal({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "w-full font-mono text-xs md:text-sm",
        className,
      )}
    >
      <div className="overflow-hidden rounded-xl border border-neutral-800 bg-neutral-900/90 backdrop-blur-xl shadow-2xl h-full flex flex-col">
        {/* Title Bar */}
        ...
        <div
          ref={contentRef}
          className="no-visible-scrollbar h-[500px] overflow-y-auto p-5 font-mono text-[13px] md:text-[15px]"
        >
          {lines.map((line, i) => (
